...
RSpec.describe Tursodb::OrganizationApi::GetAllOrganizationsForUser do
  ...
  describe "#call" do
    context "when the API call is successful" do
      ...
      before do
        stub_request(:get, "#{config.base_url}/v1/organizations")
      ...
      it "returns a Result object with tokens" do
        ...
        expect(results).to be_a(Tursodb::OrganizationApi::GetAllOrganizationsForUser::Result)
        expect(results.organizations).to be_an(Array)
        expect(results.organizations.first.name).to eq("personal")
      end
    end
    ...
    context "when the API call fails" do
      ...
      context "when status is 401" do
        ...
        it "returns an ErrorResponse object with an error message" do
          ...
          expect(error_response).to be_a(Tursodb::OrganizationApi::GetAllOrganizationsForUser::ErrorResponse)
    ...
    context "when the API call block raises an error" do
      ...
      it "returns an ErrorResponse object with an error message" do
        results = api_caller.call
        expect(results).to be_a(Tursodb::OrganizationApi::GetAllOrganizationsForUser::ErrorResponse)
